...
export const LoginResponse = zod.object({
  ...
  "privacy": zod.enum(['public', 'friends_of_friends', 'private']).optional(),
...
export const ListPostsResponseItem = zod.object({
  ...
  "visibility": zod.enum(['public', 'friends_of_friends', 'private']).optional(),
  "author": zod.object({
  "id": zod.number(),
  "email": zod.string(),
  "name": zod.string(),
...
export const CreatePostBody = zod.object({
  ...
  "locationTag": zod.string().nullish(),
  "visibility": zod.enum(['public', 'friends_of_friends', 'private']).optional()
})
